...
export default class RNSketchCanvas extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    // Si onSaveTrigger ha cambiado, devuelve un objeto con el nuevo estado
    if (nextProps.onSaveTrigger !== prevState.onSaveTriggerProp) {
      return {
        onSaveTriggerProp: nextProps.onSaveTrigger,
        shouldSave: true,
      };
    }
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      alpha: 'FF',
      onSaveTriggerProp: props.onSaveTrigger,
      shouldSave: false,
    }
